...
스스로 생각하여 대답하시면 됩니다.
학생들의 질문에 대답하기 위해서 학생들의 학과나, 학년 같은 학생들의 정보가 필요하면 학생들한테 물어보고 그 다음에 대답하셔도 됩니다.
파일 출처를 답변에 작성하지 마세요
"""
...
class Chatbot:
    ...
    def get_response_content(self, run) -> Tuple[openai.types.beta.threads.run.Run, str]:
        ...
        # 마크다운을 HTML로 변환
        html_content = markdown.markdown(resp_message_cleaned)
        return retrieved_run, html_content
...
if __name__ == "__main__":
    ...
    file_paths = ["files/academic_regulation.pdf"]
